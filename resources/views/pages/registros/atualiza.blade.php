...
<form class="form-container" method="POST" action="{{ route('atualizar.registro', $findRegistro->id) }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" value="{{ isset($findRegistro->nome) ? $findRegistro->nome : old('nome') }}"
            class="form-control @error('nome') is-invalid @enderror" id="InputNome" name='nome'>
        @if ($errors->has('nome'))
    ...
    <div class="mb-3">
        ...
        <input type="text" value="{{ isset($findRegistro->dns) ? $findRegistro->dns : old('dns') }}"
            class="form-control @error('dns') is-invalid @enderror" id="InputDNS" name='dns'>
        @if ($errors->has('dns'))
    ...
    <div class="mb-3">
        ...
        <input type="text" value="{{ isset($findRegistro->ip) ? $findRegistro->ip : old('ip') }}"
            class="form-control @error('ip') is-invalid @enderror" id="InputIp" name='ip'>
        @if ($errors->has('dns'))
    ...
    <div class="mb-3">
        ...
        <input type="date"
            value="{{ isset($findRegistro->data_registro) ? $findRegistro->data_registro : old('data_registro') }}"
            class="form-control @error('data_registro') is-invalid @enderror" id="InputData" name='data_registro'>
