...
<form class="form-container" method="POST" action="{{ route('cadastrar.registro') }}">
    ...
    <div class="mb-3">
      ...
      <input type="text" value="{{ old('nome') }}" class="form-control @error('nome') is-invalid @enderror" id="InputNome" name='nome'>
      @if ($errors->has('nome'))
    ...
    <div class="mb-3">
      ...
      <input type="text" value="{{ old('dns') }}" class="form-control @error('dns') is-invalid @enderror" id="InputDNS" name='dns'>
      @if ($errors->has('dns'))
    ...
    <div class="mb-3">
       ...
       <input type="text" value="{{ old('ip') }}" class="form-control @error('ip') is-invalid @enderror" id="InputIp" name='ip'>
       @if ($errors->has('ip'))
    ...
    <div class="mb-3">
       ...
       <input type="date" value="{{ old('data_registro') }}" class="form-control @error('data_registro') is-invalid @enderror" id="InputData" name='data_registro'>
